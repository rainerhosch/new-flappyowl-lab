...
contract FlappyOwlNftTestnet is
    ERC721A,
    ...
    ReentrancyGuard
{
    ...
    uint256 public maxSupply = 9999999; //this supply on testnet only, for test how much max DNA generated.
    ...
    *                       modifier and other operations
    ...
    function setFactory(INftFactory newFactory) external onlyOwner {
        factory = newFactory;
    }
